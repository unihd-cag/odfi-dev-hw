...
public class SystemVerilogPreprocessorParser extends Parser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "COMMENTAR_LONG", "COMMENTAR_SHORT", "CONTENT", "NEWLINE", "PREP_DEFAULT_NETTYPE", "PREP_ELSE", "PREP_ENDIF", "PREP_IFDEF", "PREP_IFNDEF", "PREP_INCLUDE", "WORD", "WS", "'\"'"
    };
...
public static class STAttrMap extends HashMap {
  ...
  public STAttrMap put(String attrName, int value) {
    ...
    public String[] getTokenNames() { return SystemVerilogPreprocessorParser.tokenNames; }
    ...
    // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:32:1: preprocess : ( ( . )* ( ifdef | ignore ) )* ;
    public final SystemVerilogPreprocessorParser.preprocess_return preprocess() throws RecognitionException {
        ...
        try {
            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:33:3: ( ( ( . )* ( ifdef | ignore ) )* )
            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:36:3: ( ( . )* ( ifdef | ignore ) )*
            {
            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:36:3: ( ( . )* ( ifdef | ignore ) )*
            loop3:
            do {
                ...
                switch (alt3) {
            	case 1 :
            	    // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:36:4: ( . )* ( ifdef | ignore )
            	    {
            	    // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:36:4: ( . )*
            	    loop1:
            	    do {
            	        int alt1=2;
            	        switch ( input.LA(1) ) {
            	    ...
            	    // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:36:7: ( ifdef | ignore )
            	    int alt2=2;
            	    ...
            	    switch (alt2) {
            	        case 1 :
            	            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:36:8: ifdef
            	            {
            	            ...
            	            break;
            	        case 2 :
            	            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:36:14: ignore
            	            {
    ...
    // $ANTLR start "ifdef"
    // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:40:1: ifdef : ifdef_if ifcontent= content (ef= PREP_ENDIF -> template(content=$ifcontent.text) \"<content>\"| ifdef_else elsecontent= content PREP_ENDIF -> template(content=$elsecontent.text) \"<content>\") ;
    public final SystemVerilogPreprocessorParser.ifdef_return ifdef() throws RecognitionException {
        ...
        Token ef=null;
        SystemVerilogPreprocessorParser.content_return ifcontent =null;

        SystemVerilogPreprocessorParser.content_return elsecontent =null;

        SystemVerilogPreprocessorParser.ifdef_if_return ifdef_if1 =null;

        SystemVerilogPreprocessorParser.ifdef_else_return ifdef_else2 =null;


        try {
            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:40:6: ( ifdef_if ifcontent= content (ef= PREP_ENDIF -> template(content=$ifcontent.text) \"<content>\"| ifdef_else elsecontent= content PREP_ENDIF -> template(content=$elsecontent.text) \"<content>\") )
            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:42:3: ifdef_if ifcontent= content (ef= PREP_ENDIF -> template(content=$ifcontent.text) \"<content>\"| ifdef_else elsecontent= content PREP_ENDIF -> template(content=$elsecontent.text) \"<content>\")
            {
            ...
            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:43:3: (ef= PREP_ENDIF -> template(content=$ifcontent.text) \"<content>\"| ifdef_else elsecontent= content PREP_ENDIF -> template(content=$elsecontent.text) \"<content>\")
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:46:5: ef= PREP_ENDIF
                    {
                    ...
                    break;
                case 2 :
                    // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:55:5: ifdef_else elsecontent= content PREP_ENDIF
                    {
    ...
    // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:66:1: ifdef_if : ( PREP_IFDEF | PREP_IFNDEF ) WORD ;
    public final SystemVerilogPreprocessorParser.ifdef_if_return ifdef_if() throws RecognitionException {
        ...
        try {
            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:66:9: ( ( PREP_IFDEF | PREP_IFNDEF ) WORD )
            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:67:3: ( PREP_IFDEF | PREP_IFNDEF ) WORD
            {
    ...
    // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:74:1: ifdef_else : PREP_ELSE ;
    public final SystemVerilogPreprocessorParser.ifdef_else_return ifdef_else() throws RecognitionException {
        ...
        try {
            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:74:11: ( PREP_ELSE )
            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:75:3: PREP_ELSE
            {
    ...
    // $ANTLR start "content"
    // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:82:1: content : ( content_text | include )* ;
    public final SystemVerilogPreprocessorParser.content_return content() throws RecognitionException {
        ...
        try {
            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:82:8: ( ( content_text | include )* )
            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:82:10: ( content_text | include )*
            {
            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:82:10: ( content_text | include )*
            loop5:
            do {
                ...
                switch (alt5) {
            	case 1 :
            	    // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:82:12: content_text
            	    {
            	    ...
            	    break;
            	case 2 :
            	    // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:82:28: include
            	    {
    ...
    // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:84:1: content_text : (~ ( PREP_ENDIF | PREP_ELSE | PREP_INCLUDE | PREP_DEFAULT_NETTYPE ) )+ ;
    public final SystemVerilogPreprocessorParser.content_text_return content_text() throws RecognitionException {
        ...
        try {
            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:84:13: ( (~ ( PREP_ENDIF | PREP_ELSE | PREP_INCLUDE | PREP_DEFAULT_NETTYPE ) )+ )
            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:84:15: (~ ( PREP_ENDIF | PREP_ELSE | PREP_INCLUDE | PREP_DEFAULT_NETTYPE ) )+
            {
            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:84:15: (~ ( PREP_ENDIF | PREP_ELSE | PREP_INCLUDE | PREP_DEFAULT_NETTYPE ) )+
            int cnt6=0;
            loop6:
    ...
    // $ANTLR start "include"
    // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:86:1: include : PREP_INCLUDE '\"' WORD '\"' -> template( \"\";
    public final SystemVerilogPreprocessorParser.include_return include() throws RecognitionException {
        ...
        try {
            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:86:8: ( PREP_INCLUDE '\"' WORD '\"' -> template( \"\")
            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:86:10: PREP_INCLUDE '\"' WORD '\"'
            {
    ...
    // $ANTLR start "ignore"
    // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:89:1: ignore : PREP_DEFAULT_NETTYPE WORD -> template( \"\";
    public final SystemVerilogPreprocessorParser.ignore_return ignore() throws RecognitionException {
        ...
        try {
            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:89:7: ( PREP_DEFAULT_NETTYPE WORD -> template( \"\")
            // /local/home/rleys/projects/phd/sw/odfi/dev/languages/antlr-recognisers/src/main/java/org/odfi/dev/languages/antlr/sv/preproc/SystemVerilogPreprocessor.g:89:9: PREP_DEFAULT_NETTYPE WORD
            {
