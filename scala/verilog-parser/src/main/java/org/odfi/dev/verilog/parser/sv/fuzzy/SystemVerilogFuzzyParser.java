...
public class SystemVerilogFuzzyParser extends XQParser {
	public static final String[] tokenNames = new String[] {
		"<invalid>", "<EOR>", "<DOWN>", "<UP>", "ALWAYS", "ASSIGN", "AT", "BAND", 
		"BASE_DATA_TYPE", "BEGIN", "BNOT", "BOR", "BSLASH", "BXNOR", "BXOR", "COLON", 
		"COMMA", "COMMENTAR_LONG", "COMMENTAR_SHORT", "DIV", "DOT", "ELSE", "ELSEIF", 
		"END", "END_GENERATE", "EQ", "EQUAL", "EQ_CASE", "EXE_QUOTE", "FPATH", 
		"GE", "GENERATE", "GT", "IDENTIFIER", "IF", "INITIAL", "LAND", "LBRACK", 
		"LCURLY", "LE", "LNOT", "LOR", "LPAREN", "LT_", "MINUS", "MOD", "MODULE", 
		"NEWLINE", "NOT_EQ", "NOT_EQ_CASE", "NUMBER", "PLUS", "PORT_DIRECTION", 
		"POUND", "PPATH", "QUESTION", "RBRACK", "RCURLY", "RNAND", "RNOR", "RPAREN", 
		"SEMI", "SL", "SQUOTE", "SR", "STAR", "SV_DATA_TYPE", "TRIGGER", "VALUE_BASE", 
		"WS"
	};
	...
	@Override public String[] getTokenNames() { return SystemVerilogFuzzyParser.tokenNames; }
	...
	// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:55:1: module_name returns [String name] : ( . )* MODULE IDENTIFIER ;
	public final String module_name() throws RecognitionException {
		...
		try {
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:56:3: ( ( . )* MODULE IDENTIFIER )
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:57:3: ( . )* MODULE IDENTIFIER
			{
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:57:3: ( . )*
			loop1:
			while (true) {
				int alt1=2;
	...
	// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:67:1: module_instanciations returns [List<String> instances] options {greedy=false; } : ( ( . )* mi= module_instanciation[$instances] )* ;
	public final List<String> module_instanciations() throws RecognitionException {
		...
		try {
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:73:3: ( ( ( . )* mi= module_instanciation[$instances] )* )
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:73:5: ( ( . )* mi= module_instanciation[$instances] )*
			{
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:73:5: ( ( . )* mi= module_instanciation[$instances] )*
			loop3:
			while (true) {
				...
				switch (alt3) {
				case 1 :
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:74:5: ( . )* mi= module_instanciation[$instances]
					{
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:74:5: ( . )*
					loop2:
					while (true) {
						int alt2=2;
	...
	// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:81:1: module_instanciations_types returns [List<String> instances] : ( ( . )* mi= module_instanciation[filteredInstances] )* ;
	public final List<String> module_instanciations_types() throws RecognitionException {
		...
		try {
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:87:3: ( ( ( . )* mi= module_instanciation[filteredInstances] )* )
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:88:5: ( ( . )* mi= module_instanciation[filteredInstances] )*
			{
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:88:5: ( ( . )* mi= module_instanciation[filteredInstances] )*
			loop5:
			while (true) {
				...
				switch (alt5) {
				case 1 :
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:89:5: ( . )* mi= module_instanciation[filteredInstances]
					{
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:89:5: ( . )*
					loop4:
					while (true) {
						int alt4=2;
	...
	// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:101:1: module_instanciation[List<String> instances] : type= IDENTIFIER ( POUND LPAREN parameter_connections RPAREN )? name= IDENTIFIER LPAREN port_connections RPAREN SEMI ;
	public final void module_instanciation(List<String> instances) throws RecognitionException {
		XQToken type=null;
		XQToken name=null;

		try {
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:104:3: (type= IDENTIFIER ( POUND LPAREN parameter_connections RPAREN )? name= IDENTIFIER LPAREN port_connections RPAREN SEMI )
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:106:5: type= IDENTIFIER ( POUND LPAREN parameter_connections RPAREN )? name= IDENTIFIER LPAREN port_connections RPAREN SEMI
			{
			type=(XQToken)match(input,IDENTIFIER,FOLLOW_IDENTIFIER_in_module_instanciation279); 
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:107:5: ( POUND LPAREN parameter_connections RPAREN )?
			int alt6=2;
			...
			switch (alt6) {
				case 1 :
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:107:6: POUND LPAREN parameter_connections RPAREN
					{
	...
	// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:119:1: port_connections : ( port_connection )? ( COMMA port_connection )* ;
	public final void port_connections() throws RecognitionException {
		try {
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:119:17: ( ( port_connection )? ( COMMA port_connection )* )
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:119:19: ( port_connection )? ( COMMA port_connection )*
			{
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:119:19: ( port_connection )?
			int alt7=2;
			...
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:119:36: ( COMMA port_connection )*
			loop8:
			while (true) {
				int alt8=2;
				...
				switch (alt8) {
				case 1 :
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:119:37: COMMA port_connection
					{
	...
	// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:121:1: port_connection : DOT port_name= IDENTIFIER LPAREN concatenable_expression RPAREN ;
	public final void port_connection() throws RecognitionException {
		XQToken port_name=null;

		try {
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:121:17: ( DOT port_name= IDENTIFIER LPAREN concatenable_expression RPAREN )
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:121:19: DOT port_name= IDENTIFIER LPAREN concatenable_expression RPAREN
			{
	...
	// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:124:1: parameter_connections : ( parameter_connection )? ( COMMA parameter_connection )* ;
	public final void parameter_connections() throws RecognitionException {
		try {
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:124:22: ( ( parameter_connection )? ( COMMA parameter_connection )* )
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:124:24: ( parameter_connection )? ( COMMA parameter_connection )*
			{
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:124:24: ( parameter_connection )?
			int alt9=2;
			...
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:124:46: ( COMMA parameter_connection )*
			loop10:
			while (true) {
				int alt10=2;
				...
				switch (alt10) {
				case 1 :
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:124:47: COMMA parameter_connection
					{
	...
	// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:125:1: parameter_connection : DOT param_name= IDENTIFIER LPAREN expression RPAREN ;
	public final void parameter_connection() throws RecognitionException {
		XQToken param_name=null;

		try {
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:125:21: ( DOT param_name= IDENTIFIER LPAREN expression RPAREN )
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:125:23: DOT param_name= IDENTIFIER LPAREN expression RPAREN
			{
	...
	// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:128:1: concatenable_expression : ( ( LCURLY expression ( COMMA expression )* RCURLY ) | expression );
	public final void concatenable_expression() throws RecognitionException {
		try {
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:128:24: ( ( LCURLY expression ( COMMA expression )* RCURLY ) | expression )
			int alt12=2;
			...
			switch (alt12) {
				case 1 :
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:129:3: ( LCURLY expression ( COMMA expression )* RCURLY )
					{
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:129:3: ( LCURLY expression ( COMMA expression )* RCURLY )
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:129:4: LCURLY expression ( COMMA expression )* RCURLY
					{
					...
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:129:22: ( COMMA expression )*
					loop11:
					while (true) {
						int alt11=2;
						...
						switch (alt11) {
						case 1 :
							// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:129:23: COMMA expression
							{
					...
					break;
				case 2 :
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:130:5: expression
					{
	...
	// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:132:1: expression : ( ( LPAREN expression RPAREN ) | expression_operand )? ( expression_operator expression )? ;
	public final void expression() throws RecognitionException {
		try {
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:132:11: ( ( ( LPAREN expression RPAREN ) | expression_operand )? ( expression_operator expression )? )
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:133:3: ( ( LPAREN expression RPAREN ) | expression_operand )? ( expression_operator expression )?
			{
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:133:3: ( ( LPAREN expression RPAREN ) | expression_operand )?
			int alt13=3;
			...
			switch (alt13) {
				case 1 :
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:133:4: ( LPAREN expression RPAREN )
					{
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:133:4: ( LPAREN expression RPAREN )
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:133:5: LPAREN expression RPAREN
					{
					...
					break;
				case 2 :
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:133:33: expression_operand
					{
			...
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:133:55: ( expression_operator expression )?
			int alt14=2;
			...
			switch (alt14) {
				case 1 :
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:133:56: expression_operator expression
					{
	...
	// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:136:1: expression_operand : ( ( IDENTIFIER ( LBRACK NUMBER RBRACK )? ) | NUMBER | typed_value );
	public final void expression_operand() throws RecognitionException {
		try {
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:136:20: ( ( IDENTIFIER ( LBRACK NUMBER RBRACK )? ) | NUMBER | typed_value )
			int alt16=3;
			...
			switch (alt16) {
				case 1 :
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:136:22: ( IDENTIFIER ( LBRACK NUMBER RBRACK )? )
					{
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:136:22: ( IDENTIFIER ( LBRACK NUMBER RBRACK )? )
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:136:23: IDENTIFIER ( LBRACK NUMBER RBRACK )?
					{
					match(input,IDENTIFIER,FOLLOW_IDENTIFIER_in_expression_operand488); 
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:136:34: ( LBRACK NUMBER RBRACK )?
					int alt15=2;
					...
					switch (alt15) {
						case 1 :
							// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:136:35: LBRACK NUMBER RBRACK
							{
					...
					break;
				case 2 :
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:136:61: NUMBER
					{
					match(input,NUMBER,FOLLOW_NUMBER_in_expression_operand502); 
					}
					break;
				case 3 :
					// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:136:70: typed_value
					{
	...
	// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:138:1: expression_operator : ( LAND | BOR | BAND | PLUS | BNOT | MINUS | STAR | BXOR | BXNOR | LNOT );
	public final void expression_operator() throws RecognitionException {
		try {
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:138:20: ( LAND | BOR | BAND | PLUS | BNOT | MINUS | STAR | BXOR | BXNOR | LNOT )
	...
	// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:141:1: typed_value : NUMBER SQUOTE VALUE_BASE NUMBER ;
	public final void typed_value() throws RecognitionException {
		try {
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:141:12: ( NUMBER SQUOTE VALUE_BASE NUMBER )
			// E:\\Common\\Projects\\git\\odfi-dev-hw\\scala\\verilog-parser\\src\\main\\java\\org\\odfi\\dev\\verilog\\parser\\sv\\fuzzy\\SystemVerilogFuzzy.g:141:14: NUMBER SQUOTE VALUE_BASE NUMBER
			{
